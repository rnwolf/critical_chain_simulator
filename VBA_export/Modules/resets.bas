...
Sub reset_project()
    ...
    If answer = vbYes Then
        ...
        With ThisWorkbook.Worksheets("DASHBOARD")
            ...
            Wend
            .ChartObjects(1).Chart.ChartTitle.Text = "Buffer cha�ne critique"
        End With

        MsgBox "La r�initialisation a supprim� la date de d�but. Veuillez indiquer la date de lancement du projet en cellule A2!"
        Call reinitialiser_GANTT_reel
    End If
